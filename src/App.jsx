...
export default function App() {
  ...
  return (
    <div className="app">
      ...
      {tab === 'today' && <TodayView entries={logEntries} goals={goals} onAdd={addEntriesWithCoaching} onUpdate={updateEntry} onDelete={deleteEntry} recipes={recipes} suggestions={suggestions} />}
